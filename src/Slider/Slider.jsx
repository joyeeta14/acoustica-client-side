...
const Slider = () => {
  return (
    ...
    <SwiperSlide>
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQZIi6ebf7MVDOlQK-tSiPwlDU7zzqZkhlLiw&usqp=CAU" alt="" />
    </SwiperSlide>
    <SwiperSlide>
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIukhYqboDnN8ez19lEKs8FnpDjfN5nNJoUg&usqp=CAU" alt="" />
    </SwiperSlide>
    <SwiperSlide>
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqWQR_yXsPiWi9-SwhZDQdHnKw2ZfCEB9pOQ&usqp=CAU" alt="" />
    </SwiperSlide>
    <SwiperSlide>
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYj66ydR7ySkYN3Z0byvwJR1OKNfp5nX8jcw&usqp=CAU" alt="" />
    </SwiperSlide>
